...
<body>
	...
	<form action="loginAction.jsp" name="f" id="f" method="post">
    	<section class="admin_bgcolor">
			<div class="admin_login">
				<span>
					...
					<div class="right_div">
						<input type="submit" class="btn_submit" value="MASTER LOGIN">
					</div> <em class="alert_msg">※ 본 사이트는 관리자 외에는 접근을 금합니다. 페이지 접근에 대한 접속 정보는 모두 기록 됩니다.</em>

				</span> <span>
					<ol class="admin_info">
						<li title="신규 관리자 등록요청" onclick="go_addmaster();">신규 관리자 등록요청</li>
						<li title="아이디/패스워드 찾기" onclick="go_search();">아이디/패스워드 찾기</li>
					</ol>
				</span>
			</div>
		</section>
